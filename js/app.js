...
// Parameter: datetime, a time delta between ticks

Enemy.prototype.update = function (datetime) {
    // You should multiply any movement by the datetime parameter
    // which will ensure the game runs at the same speed for
    // all computers.
    
    var maxPos = this.xRange[1];
    this.x += this.speed * datetime;
